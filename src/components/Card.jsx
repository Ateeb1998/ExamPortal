...
const Card = () => {
  return (
    ...
    <div className='-mt-16 flex flex-col md:flex-row border-8 rounded-xl border-white w-fit mx-auto z-10'>
      <div className='w-74 sm:w-fit flex space-x-4 py-5 px-10 items-center hover:shadow-lg transition-shadow bg-green-200 rounded-l-lg'>
      ...
      <div className='z-10 w-74 sm:w-fit flex space-x-4 py-5 px-10 items-center hover:shadow-lg transition-shadow bg-green-50'>
